...
We'll use the `LifeCycleSavings` built-in dataset.

See `?LifeCycleSavings` for more information on the included variables, and in the Console run `View(LifeCycleSavings)` to see the data. 
...
# Then for comparison, let's also create 10000 bootstrap samples with replacement
